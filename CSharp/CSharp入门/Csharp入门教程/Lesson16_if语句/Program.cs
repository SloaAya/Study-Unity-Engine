...
namespace Lesson16_条件分支语句_if
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //作用： 满足条件时 多执行一些代码
            //语法：
            //     if(bool类型值) //bool类型镶滚：bool变量 条件运算符表达式 逻辑运算符表达式
            //   {
            //     代码;
            //   }
            //注意：
            ...
            //2. 可以嵌套
            //3. else 是可以省略的
            //4. 注意 条件判断 从上到下执行 满足一个 就不再往下执行了
            ...
            { 
                Console.WriteLine("a在六和九之间");
            }
            else if (a3 >= 0 && a3 <= 5)
            {
                 Console.WriteLine("a在0和五之间");
            }
            else
            {
            ...
            //if 语句相关 if if..else  if..else if..else
            //else if 和 else 是组合使用
